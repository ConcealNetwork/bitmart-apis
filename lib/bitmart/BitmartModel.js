...
class BitmartModel extends bitmart_1.default {
    constructor(memo, access, secret) {
        ...
        this.getDepth = (symbol, precision, size) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getUserOrders = (symbol, offset, limit, status) => __awaiter(this, void 0, void 0, function* () {
            const orders = yield this.privateRequest('get', `/spot/v1/orders?symbol=${symbol}&status=${status}&offset=${offset}&limit=${limit}`, `symbol=${symbol}&status=${status}&offset=${offset}&limit=${limit}`);
            return orders;
        });
        this.getUserTrades = (symbol, orderId) => __awaiter(this, void 0, void 0, function* () {
            const orders = yield this.privateRequest('get', `/spot/v1/trades?symbol=${symbol}&order_id=${orderId}`, `symbol=${symbol}&order_id=${orderId}`);
            return orders;
        });
